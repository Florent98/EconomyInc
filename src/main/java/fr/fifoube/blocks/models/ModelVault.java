...
public class ModelVault extends Model
{
	RendererModel BASE;
	...
	public ModelVault( float par1 )
	{
	    BASE = new RendererModel( this, 0, 3 );
	    BASE.setTextureSize( 256, 128 );
	    BASE.addBox( -16F, -0.5F, -16F, 32, 1, 32);
	    BASE.setRotationPoint( 0F, 23.5F, 0F );
	    ...
	    Panel_left.addBox( -16F, -15F, -0.5F, 32, 30, 1);
	    Panel_left.setRotationPoint( 0F, 8F, 15.5F );
	    plank_support = new RendererModel( this, 99, 97 );
	    plank_support.setTextureSize( 256, 128 );
	    plank_support.addBox( -14.5F, -0.5F, -15F, 29, 1, 30);
	    plank_support.setRotationPoint( 0.5F, 8F, 0F );
	    Bills1 = new RendererModel( this, 68, 113 );
	    Bills1.setTextureSize( 256, 128 );
	    Bills1.addBox( -6F, -2F, -4F, 12, 4, 8);
	    Bills1.setRotationPoint( -3F, 5.5F, 11F );
	    Bills2 = new RendererModel( this, 100, 66 );
	    Bills2.setTextureSize( 256, 128 );
	    Bills2.addBox( -6F, -2F, -4F, 12, 4, 8);
	    Bills2.setRotationPoint( -2F, 1.5F, 11F );
	    Bills3 = new RendererModel( this, 100, 53 );
	    Bills3.setTextureSize( 256, 128 );
	    Bills3.addBox( -6F, -2F, -4F, 12, 4, 8);
	    Bills3.setRotationPoint( -2F, 5.5F, -11F );
	    Bills4 = new RendererModel( this, 97, 22 );
	    Bills4.setTextureSize( 256, 128 );
	    Bills4.addBox( -6F, -2F, -4F, 12, 4, 8);
	    Bills4.setRotationPoint( -2F, 5.5F, 1F );
	    Bills5 = new RendererModel( this, 100, 40 );
	    Bills5.setTextureSize( 256, 128 );
	    Bills5.addBox( -6F, -2F, -4F, 12, 4, 8);
	    Bills5.setRotationPoint( -1F, 1.5F, -11F );
	    ...
	    Bills_duplication.setRotationPoint( -3F, 21F, 11F );
	    Bills21 = new RendererModel( this, 68, 113 );
	    Bills21.setTextureSize( 256, 128 );
	    Bills21.addBox( -6F, -2F, -4F, 12, 4, 8);
	    Bills21.setRotationPoint( -2F, 17F, 11F );
	    Bills31 = new RendererModel( this, 97, 22 );
	    Bills31.setTextureSize( 256, 128 );
	    Bills31.addBox( -6F, -2F, -4F, 12, 4, 8);
	    Bills31.setRotationPoint( -2F, 21F, -11F );
	    Bills41 = new RendererModel( this, 100, 40 );
	    Bills41.setTextureSize( 256, 128 );
	    Bills41.addBox( -6F, -2F, -4F, 12, 4, 8);
	    Bills41.setRotationPoint( -2F, 21F, 1F );
	    Bills51 = new RendererModel( this, 100, 53 );
	    Bills51.setTextureSize( 256, 128 );
	    Bills51.addBox( -6F, -2F, -4F, 12, 4, 8);
	    Bills51.setRotationPoint( -1F, 17F, -11F );
	}
